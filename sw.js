const CACHE='vida-verde-trace360-test-v14';
const ASSETS=['./','./index.html','./styles.css','./branding.css','./branding-v14.css','./app.js','./v13.js','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./icons/logo-full.png'];
